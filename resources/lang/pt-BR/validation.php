...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        //Campos nas mensagens de erro
        'usu_login'                 => 'login',
        'usu_senha'                 => 'senha',
        'usu_nome'                  => 'mome', 
        'usu_nascimento'            => 'data de nascimento',
        'usu_cpf'                   => 'CPF', 
        'usu_num_filhos'            => 'número de filhos', 
        'usu_mae'                   => 'nome da mãe', 
        'usu_pai'                   => 'nome do pai', 
        'usu_rg'                    => 'documento de indentidade', 
        'usu_org_emissor_rg'        => 'orgão emissor', 
        'usu_uf_orgao_emissor_rg'   => 'UF do orgão emissor', 
        'usu_data_emissao_rg'       => 'data de emissão', 
        'usu_nacionalidade'         => 'nacionalidade', 
        'usu_sexo'                  => 'sexo', 
        'usu_estado_civil'          => 'estado civil', 
        'usu_raca'                  => 'raça/cor', 
        'usu_escolaridade'          => 'nível de escolaridade', 
        'usu_cep'                   => 'CEP', 
        'usu_logradouro'            => 'logradouro', 
        'usu_endereco'              => 'endereço', 
        'usu_end_num'               => 'número do endereço', 
        'usu_end_complemento'       => 'complemento do endereço', 
        'usu_bairro'                => 'bairro', 
        'usu_uf'                    => 'UF', 
        'usu_municipio'             => 'município', 
        'usu_tel'                   => 'telefone 1',
        'usu_tel2'                  => 'telefone 2', 
        'usu_email'                 => 'email', 
        'usu_autorizacao'           => 'termo de autorização', 
        'usu_naturalidade'          => 'naturalidade',
    ],
];
